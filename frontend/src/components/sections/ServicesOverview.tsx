...
export default function ServicesOverview() {
  ...
  // once: true — stays true after first intersection, so late-loading data still animates in
  ...
  return (
    <section ref={ref} className="py-20 lg:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* animate is driven by both viewport visibility AND data readiness —
            whileInView alone fires once on an empty list and never re-triggers */}
        <motion.div
          variants={containerVariants}
          initial="hidden"
          animate={isInView && services.length > 0 ? 'visible' : 'hidden'}
